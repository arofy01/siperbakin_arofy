...
namespace App\Exports\user\opd\bappeda\aplikasi\siperbakin\pamsimas;
...
class pamsimas implements FromCollection, WithHeadings
{ 
    ...
    */
    ...
    {
        $pamsimas = ModPamsimas::select('kode_kecamatan', 
