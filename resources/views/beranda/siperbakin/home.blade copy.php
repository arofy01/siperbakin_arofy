...
<body>
    ...
    <style>
        .gambar {
            width: 1510px; /* Lebar gambar */
            height: 900px; /* Tinggi gambar */
            object-fit: cover; /* Mengatur bagaimana gambar akan diisi dalam kotak */
            border: 0px solid #ccc; /* Contoh border */
            z-index: 1;
        }
    </style>
</head>
<body>
    <center><img src="https://siperbakin.acehtamiangkab.go.id/storage/siperbakin_template/images/slider-img.jpg" alt="Deskripsi Gambar" class="gambar">
</body>
</html>
