...
<h4 class="card-title">DETAIL PAMSIMAS</h4>
        ...
        <tr>
            ...
            <td>
                <div class="mt-3 mb-3">
                    ...
                    <img src="data:image/jpeg;base64,{{ base64_encode(file_get_contents(storage_path('app/public/images/siperbakin/pamsimas/' . $pdfdata->kondisi_eksisting))) }}"
