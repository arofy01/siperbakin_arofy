<div>
    <section class="section">
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    <div class="modal-success me-1 mb-1 d-inline-block">
                                        <button type="button" wire:click="LihatDesa({{ $data->id }})"
                                ...
                                <td>
                                    <div class="modal-success me-1 mb-1 d-inline-block">
                                        <button type="button" wire:click="EditDesa({{ $data->id }})"
        ...
        <!--Tambah Modal -->
        <div wire:ignore.self class="modal fade" id="ModalTambahDesa" tabindex="-1"
            aria-labelledby="exampleModalScrollableTitle" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-dialog-scrollable" role="document">

                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title" id="exampleModalScrollableTitle">Tambah Desa</h5>
                        ...
                        <form wire:submit.prevent="create">
                            <div class="modal-body">
                                ...
                                <div class="form-group mt-2">
                                    <input type="text" wire:model="KodeDesa" placeholder="Kode Desa"
                                        class="form-control">
                                    @error('KodeDesa')
                                ...
                                <div class="form-group mt-2">
                                    <input type="text" wire:model="NamaDesa" placeholder="Nama Desa"
                                        class="form-control">
                                    @error('NamaKecamatan')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
        ...
        <!--Edit Modal -->
        <div wire:ignore.self class="modal fade" id="ModalEditDesa" tabindex="-1"
            aria-labelledby="exampleModalScrollableTitle" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
