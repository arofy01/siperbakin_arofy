<div>
    <section class="section container">
        ...
        <div class="page-heading">
            ...
            <p>Organisasi Perangkat Daerah yang terlibat dalam Program Konvergensi di Kabupaten Aceh Tamiang</p>
        ...
        <div class="card">
            <div class="card-header">
                ...
                {{-- <input type="search" wire:model="CariOpd" class="form-control float-end mx-2"
                    placeholder="Cari OPD" style="width:230px;"> --}}
            </div>
