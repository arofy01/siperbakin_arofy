        ...
        <div class="container">
            <ul>
                ...
                @if (auth()->user()->hasRole('opd'))
                    <li class="menu-item  ">
                        <a href="/user/opd/dashboard" class='menu-link'>
                ...
                @elseif(auth()->user()->hasRole('bappeda-sidarendu'))
                    <li class="menu-item  ">
                        <a href="/user/opd/bappeda/aplikasi/sidarendu/dashboard" class='menu-link'>
                            <i class="bi bi-grid-fill"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                        ...
                        <div class="submenu-group-wrapper">
                            ...
                            <ul class="submenu-group">
                                ...
                                <li class="submenu-item  ">
                                    <a href="/user/opd/bappeda/aplikasi/sidarendu/client/daftardata"
                                        class='submenu-link'>Kumpulan Data Perencanaan</a>
                                </li>

                                {{-- <li class="submenu-item  ">
                                    <a href="component-alert.html" class='submenu-link'>Geograpi Desa</a>
                                </li> --}}
