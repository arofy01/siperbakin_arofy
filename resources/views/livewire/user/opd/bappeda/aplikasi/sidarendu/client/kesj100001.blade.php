<div>
    <div class="content-wrapper container">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="mb-4 mt-4 text-center">
                    <h4><b>JUMLAH KELUARGA MENURUT TINGKAT KESEJAHTERAAN</b></h4>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                    wire:click="TampilModalTambahkesj100001">
                    Tambah Data +
                </button>

                <button type="button" class="btn btn-outline-info" data-bs-toggle="modal"
                    wire:click="TampilModalLihatkesj100001">
                    Download
                </button> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="modal-success me-1 mb-1 d-inline-block">
                                        <button type="button" wire:click="Editkesj100001({{ $data->id }})"
        ...
        <!--Modal Tambah -->
        <div wire:ignore.self class="modal fade" id="ModalTambahkesj100001" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-md" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="Simpankesj100001">
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="col-md-4">
                                            <label>Prasejahtera</label>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <input type="text" id="contact-info" class="form-control" name="Prasejahtera"
                                                placeholder="Prasejahtera" wire:model="Prasejahtera"  onkeydown="return isNumberOrDot(event)">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <label>Sejahtera I</label>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <input type="text" id="contact-info" class="form-control" name="SejahteraI"
                                                placeholder="Sejahtera I" wire:model="SejahteraI" onkeydown="return isNumberOrDot(event)">
                                        </div>
                                        @error('SejahteraI')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        ...
                                        <div class="col-md-4">
                                            <label>Sejahtera II</label>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <input type="text" id="contact-info" class="form-control"
                                                name="SejahteraII" placeholder="Sejahtera II" wire:model="SejahteraII" onkeydown="return isNumberOrDot(event)">
                                        </div>
                                        @error('SejahteraII')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        ...
                                        <div class="col-md-4">
                                            <label>Sejahtera III</label>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <input type="text" id="contact-info" class="form-control"
                                                name="SejahteraIII" placeholder="Sejahtera III" wire:model="SejahteraIII" onkeydown="return isNumberOrDot(event)">
                                        </div>
                                        @error('SejahteraIII')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        ...
                                        <div class="col-md-4 form-group">
                                            <input type="text" id="contact-info" class="form-control"
                                                name="SejahteraIIIplus" placeholder="Sejahtera III+" wire:model="SejahteraIIIplus" onkeydown="return isNumberOrDot(event)">
                                        </div>
                                        @error('SejahteraIIIplus')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
        ...
        <!--Modal Edit -->
        <div wire:ignore.self class="modal fade" id="ModalEditkesj100001" tabindex="-1"
            aria-labelledby="exampleModalScrollableTitle" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-dialog-scrollable modal-md" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="Updatekesj100001">
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col">
                                        <div class="col-md-4">
        ...
        <!--Modal Lihat-->
        <div wire:ignore.self class="modal fade" id="ModalLihatkesj100001" tabindex="-1"
            aria-labelledby="exampleModalScrollableTitle" aria-hidden="true" style="display: none;">
                        ...
                        @if ($TahunFilter)
                            <div class="modal-info me-1 mb-1 d-inline-block">
                                ...
                                <a type="button" target="_blank"
                                    href="/api/user/opd/bappeda/aplikasi/sidarendu/kesj100001?tahun={{ $TahunFilter }}"
                                    class="btn btn-sm btn-warning rounded-pill">
