<div>
    <div class="content-wrapper container">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="mb-4 mt-4 text-center">
                    <h4><b>JUMLAH SEKOLAH SMP MENURUT KECAMATAN</b></h4>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                    wire:click="TampilModalTambahpend100001">
                    Tambah Data
                </button>

                <button type="button" class="btn btn-outline-info" data-bs-toggle="modal"
                    wire:click="TampilModalLihatpend100001">
                    Download
                </button>
            ...
            <div class="card-body mt-2" style="overflow-x:auto;">
                ...
                <table class="table table-striped" style="width:100%; white-space: nowrap;">
                    ...
                    <tbody>
                        <?php $no = 1; ?>
                        @forelse ($pend100001 as $data)
                            <tr>
                                <td>{{ $no }}</td>
                                <td>{{ $data->district->name }}</td>
                                <td>{{ $data->sekolah_negeri }}</td>
                                <td>{{ $data->sekolah_swasta }}</td>
                                <td>{{ $data->tahun}}</td>
                                <td>
                                    <div class="modal-success me-1 mb-1 d-inline-block">
                                        <button type="button" wire:click="Editpend100001({{ $data->id }})"
        ...
        <!--Modal Tambah -->
        <div wire:ignore.self class="modal fade" id="ModalTambahpend100001" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-md" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="Simpanpend100001">
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="col-md-4">
                                            <label>Sekolah Negeri</label>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <input type="text" id="contact-info" class="form-control" name="SekolahNegeri"
                                                placeholder="Sekolah Negeri" wire:model="SekolahNegeri"  onkeydown="return isNumberOrDot(event)">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <label>Sekolah Swasta</label>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <input type="text" id="contact-info" class="form-control" name="SekolahSwasta"
                                                placeholder="Sekolah Swasta" wire:model="SekolahSwasta" onkeydown="return isNumberOrDot(event)">
                                        </div>
                                        @error('SekolahSwasta')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
        ...
        <!--Modal Edit -->
        <div wire:ignore.self class="modal fade" id="ModalEditpend100001" tabindex="-1"
            aria-labelledby="exampleModalScrollableTitle" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-dialog-scrollable modal-md" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="Updatepend100001">
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4 form-group">
                                            <input type="text" id="contact-info" class="form-control"
                                                name="SekolahNegeri" placeholder="Sekolah Negeri" wire:model="SekolahNegeri" onkeydown="return isNumberOrDot(event)">
                                            @error('SekolahNegeri')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4 form-group">
                                            <input type="text" id="contact-info" class="form-control"
                                                name="SekolahSwasta" placeholder="Sekolah Swasta" wire:model="SekolahSwasta" onkeydown="return isNumberOrDot(event)">
                                            @error('Sedang')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
        ...
        <!--Modal Lihat-->
        <div wire:ignore.self class="modal fade" id="ModalLihatpend100001" tabindex="-1"
            aria-labelledby="exampleModalScrollableTitle" aria-hidden="true" style="display: none;">
                        ...
                        @if ($TahunFilter)
                            <div class="modal-info me-1 mb-1 d-inline-block">
                                ...
                                <a type="button" target="_blank"
                                    href="/api/user/opd/bappeda/aplikasi/sidarendu/pend100001?tahun={{ $TahunFilter }}"
                                    class="btn btn-sm btn-warning rounded-pill">
                            ...
                            <tbody>
                                ...
                                @forelse ($LihatData as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->sekolah_negeri }}</td>
                                        <td>{{ $data->sekolah_swasta }}</td>
                                        <td>{{ $data->sekolah_negeri + $data->sekolah_swasta }}</td>
                                    </tr>
                                    <?php $no++; ?>
                                @empty
                                    <tr>
