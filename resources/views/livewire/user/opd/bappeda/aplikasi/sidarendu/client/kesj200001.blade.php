<div>
    <div class="content-wrapper container">
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="mb-4 mt-4 text-center">
                    <h4><b>JUMLAH PENYANDANG MASALAH KESEJAHTERAAN SOSIAL (PMKS) GELANDANGAN</b></h4>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                    wire:click="TampilModalTambahkesj200001">
                    Tambah Data
                </button>

                <button type="button" class="btn btn-outline-info" data-bs-toggle="modal"
                    wire:click="TampilModalLihatkesj200001">
                    Download
                </button>
            ...
            <div class="card-body mt-2" style="overflow-x:auto;">
                ...
                <table class="table table-striped" style="width:100%; white-space: nowrap;">
                    ...
                    <tbody>
                        <?php $no = 1; ?>
                        @forelse ($kesj200001 as $data)
                            <tr>
                                <td>{{ $no }}</td>
                                <td>{{ $data->district->name }}</td>
                                <td>{{ $data->gelandangan_pengemis }}</td>
                                <td>{{ $data->tahun }}</td>
                                <td>
                                    <div class="modal-success me-1 mb-1 d-inline-block">
                                        <button type="button" wire:click="Editkesj200001({{ $data->id }})"
        ...
        <!--Modal Tambah -->
        <div wire:ignore.self class="modal fade" id="ModalTambahkesj200001" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-md" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="Simpankesj200001">
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="col-md-4">
                                            <label>Gelandangan / Pengemis</label>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <input type="text" id="contact-info" class="form-control"
                                                name="GelandanganPengemis" placeholder="Gelandangan / Pengemis"
                                                wire:model="GelandanganPengemis"
                                                onkeydown="return isNumberOrDot(event)">
                                        </div>

                                        @error('GelandanganPengemis')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        ...
                                        <div class="col-md-4 form-group">
                                            <input type="text" id="contact-info" class="form-control" name="Tahun"
                                                placeholder="Tahun" wire:model="Tahun"
                                                onkeydown="return isNumberOrDot(event)">
                                        </div>
                                        @error('Tahun')
                                            <span class="text-danger">{{ $message }}</span>
        ...
        <!--Modal Edit -->
        <div wire:ignore.self class="modal fade" id="ModalEditkesj200001" tabindex="-1"
            aria-labelledby="exampleModalScrollableTitle" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-dialog-scrollable modal-md" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="Updatekesj200001">
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col">
                                        <div class="col-md-4">
        ...
        <!--Modal Lihat-->
        <div wire:ignore.self class="modal fade" id="ModalLihatkesj200001" tabindex="-1"
            aria-labelledby="exampleModalScrollableTitle" aria-hidden="true" style="display: none;">
                        ...
                        @if ($TahunFilter)
                            <div class="modal-info me-1 mb-1 d-inline-block">
                                ...
                                <a type="button" target="_blank"
                                    href="/api/user/opd/bappeda/aplikasi/sidarendu/kesj200001?tahun={{ $TahunFilter }}"
                                    class="btn btn-sm btn-warning rounded-pill">
